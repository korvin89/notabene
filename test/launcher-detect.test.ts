...
describe("launcher selection", () => {
	...
	test("waitForDone before open — a programming error, not a silent wait", async () => {
		const launcher = selectLauncher({ env: { HERDR_ENV: "1" } });
